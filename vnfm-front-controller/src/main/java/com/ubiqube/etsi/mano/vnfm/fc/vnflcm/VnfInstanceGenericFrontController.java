...
public interface VnfInstanceGenericFrontController {
	...
	<U> ResponseEntity<String> search(MultiValueMap<String, String> requestParams, Function<VnfInstance, U> mapper, @Nullable String nextpageOpaqueMarker, Consumer<U> makeLink, Class<U> frontClass);
