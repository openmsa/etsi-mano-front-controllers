...
public interface FaultMngtSubscriptionsFrontController {
	...
	<U> ResponseEntity<U> create(Subscription fmSubscriptionRequest, Function<Subscription, U> mapper, Class<?> versionController, Consumer<U> makeLink, Function<U, String> getSelfLink);
