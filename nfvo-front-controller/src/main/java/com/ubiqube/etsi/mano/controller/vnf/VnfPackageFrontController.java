...
public interface VnfPackageFrontController {
	...
	<U> ResponseEntity<U> findByIdReadOnly(UUID vnfPkgId, Function<VnfPackage, U> mapper, Consumer<U> makeLinks);
	...
	<U> ResponseEntity<String> search(MultiValueMap<String, String> requestParams, Function<VnfPackage, U> mapper, Consumer<U> makeLinks, Class<U> frontClass);
