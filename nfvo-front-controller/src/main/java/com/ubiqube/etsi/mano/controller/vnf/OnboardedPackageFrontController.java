...
public interface OnboardedPackageFrontController {
	...
	<U> ResponseEntity<String> onboardedSearch(MultiValueMap<String, String> requestParams, Function<VnfPackage, U> mapper, Consumer<U> makeLinks, Class<U> frontClass);
