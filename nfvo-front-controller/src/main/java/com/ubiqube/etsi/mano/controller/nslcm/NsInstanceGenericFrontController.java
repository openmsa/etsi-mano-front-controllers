...
public interface NsInstanceGenericFrontController {
	...
	<U> ResponseEntity<String> search(MultiValueMap<String, String> requestParams, Function<NsInstanceDto, U> mapper, String nextpageOpaqueMarker, Consumer<U> makeLink, Class<?> frontClass);
